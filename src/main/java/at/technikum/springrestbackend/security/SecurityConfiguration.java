        ...
        httpSecurity
                .authorizeHttpRequests(
                        registry -> registry
                                ...
                                .requestMatchers("/auth/token/email").permitAll()
                                ...
                                .requestMatchers("/orders/{username}").hasAnyRole("admin", "user")
                                ...
                                .requestMatchers("/users/email/{email}").hasAnyRole("admin", "user")
                                .requestMatchers("/users/*").hasRole("admin")
                                .requestMatchers("user/role/{username}").hasRole("admin")
                                .requestMatchers("/register").permitAll()
                                .requestMatchers("/deleteUser/{id}").hasAnyRole("admin", "user")
                                .requestMatchers("/deleteUsername/{usernameD}").hasAnyRole("admin", "user")
                                .requestMatchers("/updateUser/{name}").hasAnyRole("admin", "user")
                                .requestMatchers("/uploadImage/{username}").hasAnyRole("admin", "user")
